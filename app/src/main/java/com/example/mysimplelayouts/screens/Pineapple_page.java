...
public class Pineapple_page extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private Spinner mySpinner;
    private View backArrow, descriptionArrow;
    private Button decrementButton, incrementButton, cart;
    private TextView quantityTextView, pineapplePriceTextView, pineappleTextView;
    ...
    protected void onPause() {
        ...
        myEditor.putString(AppConstant.pineappleText, pineappleTextView.getText().toString());
        myEditor.putInt(AppConstant.pineapplePrice, quantity * 700);
        myEditor.apply();
    }
    ...
    public void inItListener(){
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(Pineapple_page.this, DashBoard_page.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Pineapple_page.this, Cart_page.class);
                startActivity(myIntent);
            }
        });
        ...
        descriptionArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Pineapple_page.this, Pineapple_page.class);
                startActivity(myIntent);
            }
        });
    ...
    public void displayPrice(int number){
        pineapplePriceTextView.setText(NumberFormat.getCurrencyInstance().format(number));
    }

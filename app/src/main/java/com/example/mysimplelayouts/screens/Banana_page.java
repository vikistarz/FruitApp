...
public class Banana_page extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private Spinner mySpinner;
    private View backArrow, descriptionArrow;
    private Button decrementButton, incrementButton, cart;
    private TextView quantityTextView, bananaPriceTextView, bananaTextView;
    ...
    protected void onPause() {
        ...
        myEditor.putString(AppConstant.appleText, bananaTextView.getText().toString());
        myEditor.putInt(AppConstant.applePrice, quantity * 500);
        myEditor.apply();

//        AppPreferenceHelper.saveIntPrefValue(this, AppConstant.totalPrice, quantity * 500);
    }
    ...
    public void inItListener() {
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(Banana_page.this, DashBoard_page.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Banana_page.this, Cart_page.class);
                startActivity(myIntent);
            }
        });
        ...
        descriptionArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Banana_page.this, BananaDescription.class);
                startActivity(myIntent);
            }
        });
    ...
    public void displayPrice(int number) {
        bananaPriceTextView.setText(NumberFormat.getCurrencyInstance().format(number));
    }

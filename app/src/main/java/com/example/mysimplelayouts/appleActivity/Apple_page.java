package com.example.mysimplelayouts.appleActivity;
...
import com.example.mysimplelayouts.screens.AppleDescription;
import com.example.mysimplelayouts.screens.Cart_page;
import com.example.mysimplelayouts.screens.DashBoard_page;

import java.text.NumberFormat;

public class Apple_page extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    private Spinner mySpinner;
    private View backArrow, descriptionArrow;
    private Button decrementButton, incrementButton, cart;
    private TextView quantityTextView, applePriceTextView, appleTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apple_page);
    ...
    protected void onPause() {
        ...
        myEditor.putString(AppConstant.appleText, appleTextView.getText().toString());
        myEditor.putInt(AppConstant.applePrice, quantity * 200);
        myEditor.apply();
    ...
    public void inItListener(){
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(Apple_page.this, DashBoard_page.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Apple_page.this, Cart_page.class);
                startActivity(myIntent);
            }
        });
        ...
        descriptionArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(Apple_page.this, AppleDescription.class);
                startActivity(myIntent);
            }
        });
    ...
    public void displayPrice(int number){
        applePriceTextView.setText(NumberFormat.getCurrencyInstance().format(number));
    }
